...
internal class TreasureCofferMarkerFactory(IObjectTable objectTable, IZoneManager zoneManager) : WorldMarkerFactory
{
    ...
    private void OnTick()
    {
        ...
        foreach (IGameObject obj in objectTable) {
            if (!obj.IsValid() || (obj.ObjectKind != ObjectKind.Treasure && (obj.ObjectKind != ObjectKind.EventObj || obj.DataId is not (2007357 or 2007358 or 2007543))) || !obj.IsTargetable) continue;
            unsafe {
